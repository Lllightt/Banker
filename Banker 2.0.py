...
#✔ NOWE GUI
#✔ DEBUFF Z Bitcoin
#✔ TERAZ ULEPSZENIA ROBIĄ SIE 2x

#Banker 10/05/2025 21:41
#Update 2.1 czy odrazu 3.0?
...
if PrawLogin == Login and PrawPin == Pin:
    ...
    while True:
        ...
        if wybor == "1":
            ...
            print("\n╭-  MENU EDUKACJI -╯")
            print("1. Harvard  | 100k zł | | +15 LVL |☆ ")
            print("2. Stanford | 10k zł | | +10 LVL |✧")
            print("3. Batory   | 1k zł | | +5 LVL |")
            print("4. Zagle    | 100 zł | | +1 LVL |")
            print("5. Wyjdz")
...
#STRONA 2
            ...
            if Wybor2 == "7":
                ...
                if FirmaChoose == "1":
                    ...
                    print(" ")
                    print(f"Plan 1 - | {Cena_Upgrade_1} | | + 2 Popularnośći FIRMY | ")
                    print(f"Plan 2 - | {Cena_Upgrade_2} | | + 4 Popularnośći FIRMY | ")
                    print(f"Plan 3 - | {Cena_Upgrade_3} | | + 10 Popularnośći FIRMY | ")
