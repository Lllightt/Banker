        ...
        if wybor == "1":
            ...
            if Wybor2 == "7":
                ...
                if FirmaChoose == "1":
                    ...
                    print(" ")
                    print("Plan 1 - | 200 zł | | + 2 Popularnośći FIRMY | ")
                    print("Plan 2 - | 450 zł | | + 4 Popularnośći FIRMY | ")
                    print("Plan 3 - | 1150 zł | | + 10 Popularnośći FIRMY | ")
                    WybierzPlan = input("Wybierz plan: ").lower()

                    if WybierzPlan == "plan 1" and  konto >= 200:
                        konto -= 200
                        firma_Popularity += 2
                    elif WybierzPlan == "plan 2" and  konto >= 450:
                        konto -= 450
                        firma_Popularity += 4
                    elif WybierzPlan == "plan 3" and  konto >= 1150:
                        konto -= 1150
                        firma_Popularity += 10
                    else:
