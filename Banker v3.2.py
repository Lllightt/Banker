...
#Strona 2
    def open_page2():
        ...
        def kupno_mineraly():
            ...
            #LABELE
            label_zloto = tk.Label(main_mineral,text=f"Posiadane Złoto: {posiadane_zloto}",fg="Black", font=("Fixedsys", 24), wraplength=500)
            label_zloto.pack(pady=5)
            label_srebro = tk.Label(main_mineral,text=f"Posiadane Srebro: {posiadane_srebro}",fg="Black", font=("Fixedsys", 24), wraplength=500)
            label_srebro.pack(pady=5)
            label_diament = tk.Label(main_mineral,text=f"Posiadane Diamenty: {posiadane_diament}",fg="Black", font=("Fixedsys", 24), wraplength=500)
